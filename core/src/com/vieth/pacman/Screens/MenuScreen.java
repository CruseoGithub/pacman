...
public class MenuScreen implements Screen {
    ...
    public MenuScreen(Game aGame) {
        ...
        Label title = new Label("Main Menu", PacMan.gameSkin,"big-black");
        title.setAlignment(Align.center);
        title.setY(Gdx.graphics.getHeight()*2/3);
        title.setWidth(Gdx.graphics.getWidth());
        stage.addActor(title);

        TextButton playButton = new TextButton("Levels",PacMan.gameSkin);
        ...
        TextButton optionsButton = new TextButton("Options",PacMan.gameSkin);
