        ...
        if(itemTaken){
            ...
            switch(((GameMap)map).countItems()){
                case 4:
                    ...
                    break;
                case 3:
                    if(itemCoolDown < 0) this.map.generateRandomItem();
                    break;
                case 2:
                    if(itemCoolDown < 10) this.map.generateRandomItem();
                    break;
                case 1:
                    if(itemCoolDown < 20) this.map.generateRandomItem();
                    break;
                case 0:
                    if(itemCoolDown < 30) this.map.generateRandomItem();
                    break;
            }
        }
    }
